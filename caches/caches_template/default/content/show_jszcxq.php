...
<link rel="stylesheet" href="<?php echo CSS_PATH;?>aoli-css/dongtai-xq.css">
	...
	<?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=91a991db5f09156ce67beffb3bea27a3&action=lists&catid=22&oeder=listorder+ASC&num=1&moreinfo=1\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'lists')) {$data = $content_tag->lists(array('catid'=>'22','oeder'=>'listorder ASC','moreinfo'=>'1','limit'=>'1',));}?>
			<div class="zj1-seven">
