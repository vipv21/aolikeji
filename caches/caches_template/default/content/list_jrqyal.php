...
<link rel="stylesheet" href="<?php echo CSS_PATH;?>aoli-css/dongtai.css">
    ...
    <div class="zj1-bigbox">
        <div class="zj1-box">
            ...
            <?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=43f7e3ed3670b63018d1230d72c0dd25&action=lists&catid=20&order=listorder+ASC&num=1\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'lists')) {$data = $content_tag->lists(array('catid'=>'20','order'=>'listorder ASC','limit'=>'1',));}?> 
            ...
            <?php if(defined('IN_ADMIN') && !defined('HTML')) {echo '</div>';}?>
                ...
                <div class="zj1-fy">
                    <div class="zj1-fywz">总数10条  当前页数：1/1 <a href="">首页</a>   上一页 <a href="">1</a>下一页  <a href="">尾页</a> </div>
                </div>
            </div>
        </div>
    </div>
